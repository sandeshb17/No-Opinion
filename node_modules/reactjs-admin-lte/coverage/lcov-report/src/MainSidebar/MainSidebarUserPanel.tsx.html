...
<html lang="en">
<head>
    <title>Code coverage report for src/MainSidebar/MainSidebarUserPanel.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/MainSidebar</a> MainSidebarUserPanel.tsx
    </h1>
    <div class='clearfix'>
...
const propTypes = {<span class="cstat-no" title="statement not covered" ></span>
  ch<span class="cstat-no" title="statement not covered" >ildren: PropTypes.node,</span>
};
&nbsp;
